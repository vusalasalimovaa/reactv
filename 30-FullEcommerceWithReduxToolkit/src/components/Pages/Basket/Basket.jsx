...
const Basket = () => {
  ...
  const { basketTotalAmount } = useSelector((store) => store.basket);
  //   console.log(baskets);
  ...
  const handleRemoveFromBasket = (basketElem) => {
    dispatch(removeFromBasket(basketElem));
  };

  const handleDecreaseBasket = (basketElem) => {
    dispatch(decreaseBasket(basketElem));
  };

  const handleIncreaseBasket = (basketElem) => {
    dispatch(addToBasket(basketElem));
  };
                ...
                >
                  ...
                  <div className="flex items-center flex-col min-[550px]:flex-row w-full max-xl:max-w-xl max-xl:mx-auto gap-2">
                    ...
                    <div className="flex items-center w-full mx-auto justify-center">
                      <button
                        onClick={() => handleDecreaseBasket(basketElem)}
                      ...
                      <p className="border-y border-gray-200 outline-none text-gray-900 font-semibold text-lg w-full max-w-[118px] min-w-[80px] placeholder:text-gray-900 py-[15px] text-center bg-transparent">
                        {basketElem.basketQuantity}
                      </p>
                      <button
                        onClick={() => handleIncreaseBasket(basketElem)}
                    ...
                    <h6 className="text-indigo-600 font-manrope font-bold text-2xl leading-9 w-full max-w-[176px] text-center">
                      ${basketElem.price * basketElem.basketQuantity}
                    </h6>
                    ...
                    >
                      <svg
                        onClick={() => handleRemoveFromBasket(basketElem)}
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
